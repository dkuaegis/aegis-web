...
function Contact() {
  ...
  const presidentName =
    language === "ko"
      ? import.meta.env.VITE_PRESIDENT_NAME_KO
      : import.meta.env.VITE_PRESIDENT_NAME_EN;
  const presidentPhone = import.meta.env.VITE_PRESIDENT_PHONE;
        ...
        <section className="contact">
          <div className="contact-inner">
            ...
            <div className="contact-card phone-card">
              ...
              {t("pages.contact.presidentLabel")} {presidentName}{" "}
              {presidentPhone}
              <button
                type="button"
                onClick={(e) => {
                  e.preventDefault();
                  copyToClipboard(presidentPhone);
                }}
